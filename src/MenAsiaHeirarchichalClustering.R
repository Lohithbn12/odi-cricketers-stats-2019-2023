...
data <- read.csv("C:\\Users\\lohithlikith\\Documents\\Lohith B N\\Project work\\MenbatsmansAsia.csv")
...
plot(hc, hang = -1, labels = data$NAME, main = "Hierarchical Clustering Dendrogram",asp=0.5)
...
# Load the dataset (replace 'your_data.csv' with the actual file path)
data <- read.csv("C:\\Users\\lohithlikith\\Documents\\Lohith B N\\Project work\\MenbowlerAsia.csv")
...
# Load the dataset (replace 'your_data.csv' with the actual file path)
data <- read.csv("C:\\Users\\lohithlikith\\Documents\\Lohith B N\\Project work\\MenallroundersAsia.csv")
